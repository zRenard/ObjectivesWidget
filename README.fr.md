...
* (**nouveautés**) Ajout du support des Fenix 7 et des nouveaux modèles
...
## 1.5.2
* (*correction*) Erreurs dans la gestions des heures des évènements
...
* (*correction*) Quelques ajustements mineur des couleurs pour être plus lisible.
* (*correction*) Quelques ajustements mineur des tailles des textes pour être plus lisible.
...
* (*correction*) Suppression d'accès à certaines données (inutiles)
