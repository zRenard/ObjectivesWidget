...
* (**new**) Adding support for Enduro 3
* (**new**) Support new SDK

### 1.5.10

* (**new**) Adding support for Fenix8 AMOLED et MIPS, Forerunner 970 and Forerunner 570
* (**new**) Support new SDK

### 1.5.8

* (**new**) Adding support for Fenix7s pro, Fenix7 pro, Fenix7x pro, Forerunner 265, Forerunner 965, and Vivoactive 5
* (**new**) Support new SDK
